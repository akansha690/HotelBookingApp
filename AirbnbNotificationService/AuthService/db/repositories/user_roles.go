...
type UserRoleRepository interface {
	...
	GetUserPermissions(userId int64) ([]*model.Permission, error)
...
func (ur *UserRoleRepositoryImpl) GetUserRoles(userId int64) ([]*model.Role, error) {
	query := `
...
func (ur *UserRoleRepositoryImpl) GetUserPermissions(userId int64) ([]*model.Permission, error) {
	query := `
