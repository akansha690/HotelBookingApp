...
type RolePermissionRepository interface {
	GetRolePermissionById(id int64) (*model.RolePermission, error)
	GetRolePermissionByRoleId(roleId int64) ([]*model.RolePermission, error)
...
func (rp *RolePermissionRepositoryImpl) GetRolePermissionById(id int64) (*model.RolePermission, error) {
...
func (rp *RolePermissionRepositoryImpl) GetRolePermissionByRoleId(roleId int64) ([]*model.RolePermission, error) {
...
func (rp *RolePermissionRepositoryImpl) AddPermissionToRole(roleId int64, permissionId int64) (*model.RolePermission, error) {
...
func (rp *RolePermissionRepositoryImpl) GetAllRolePermissions() ([]*model.RolePermission, error) {
