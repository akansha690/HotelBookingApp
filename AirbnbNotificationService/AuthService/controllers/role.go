...
func (rc *RoleController) AssignRoleToUser(w http.ResponseWriter, r *http.Request) {
	...
	if roleId == "" {
		utils.WriteErrorResponse(w, http.StatusBadRequest, "Role ID is required", fmt.Errorf("missing role ID"))
		return
	}

	roleIdInt, err := strconv.ParseInt(roleId, 10, 64)
	if err != nil {
		utils.WriteErrorResponse(w, http.StatusBadRequest, "Invalid role ID", err)
		return
	}

	userIdInt, err := strconv.ParseInt(userId, 10, 64)
	if err != nil {
		utils.WriteErrorResponse(w, http.StatusBadRequest, "Invalid user ID", err)
		return
	}

	err = rc.RoleService.AssignRoleToUser(userIdInt, roleIdInt)
	if err != nil {
		utils.WriteErrorResponse(w, http.StatusInternalServerError, "Failed to assign role to user", err)
		return
	}

	utils.WriteSuccessResponse(w, http.StatusOK, "Role assigned to user successfully", nil)
...
func (rc *RoleController) GetRoleById(w http.ResponseWriter, r *http.Request) {
	...
	if role == nil {
		utils.WriteErrorResponse(w, http.StatusNotFound, "Role not found", fmt.Errorf("role with ID %d not found", id))
		return
	}
...
func (rc *RoleController) CreateRole(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		utils.WriteErrorResponse(w, http.StatusInternalServerError, "Failed to create role", err)
		return
	}

	utils.WriteSuccessResponse(w, http.StatusCreated, "Role created successfully", role)
}
...
func (rc *RoleController) UpdateRole(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		utils.WriteErrorResponse(w, http.StatusInternalServerError, "Failed to update role", err)
		return
	}
...
func (rc *RoleController) DeleteRole(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		utils.WriteErrorResponse(w, http.StatusInternalServerError, "Failed to delete role", err)
		return
	}

	utils.WriteSuccessResponse(w, http.StatusOK, "Role deleted successfully", nil)
}
...
func (rc *RoleController) GetRolePermissions(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		utils.WriteErrorResponse(w, http.StatusInternalServerError, "Failed to fetch role permissions", err)
		return
	}

	utils.WriteSuccessResponse(w, http.StatusOK, "Role permissions fetched successfully", rolePermissions)
}
...
func (rc *RoleController) AssignPermissionToRole(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		utils.WriteErrorResponse(w, http.StatusInternalServerError, "Failed to assign permission to role", err)
		return
	}

	utils.WriteSuccessResponse(w, http.StatusCreated, "Permission assigned to role successfully", rolePermission)
}
...
func (rc *RoleController) RemovePermissionFromRole(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		utils.WriteErrorResponse(w, http.StatusInternalServerError, "Failed to remove permission from role", err)
		return
	}

	utils.WriteSuccessResponse(w, http.StatusOK, "Permission removed from role successfully", nil)
}
...
func (rc *RoleController) GetAllRolePermissions(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		utils.WriteErrorResponse(w, http.StatusInternalServerError, "Failed to fetch all role permissions", err)
		return
	}

	utils.WriteSuccessResponse(w, http.StatusOK, "All role permissions fetched successfully", rolePermissions)
}