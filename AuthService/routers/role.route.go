...
import (
	...
	middlewares "AuthInGo/middlewares"
...
func NewRoleRouter(_roleController *controller.RoleController) Router {
	return &RoleRouter{
...
func (rr *RoleRouter) Register(r chi.Router) {
	...
	r.With(middlewares.JWTNextMiddleware, middlewares.RequireAllRoles("admin")).Post("/roles/{userId}/assign/{roleId}", rr.roleController.AssignRoleToUser)
}